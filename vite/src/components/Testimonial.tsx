...
const Testimonial = () => {
  return (
    <div className='py-28'>
    <Title title='What our customers say' subTitle='Discover why discerning travelers choose stayventure for their luxury accommodation roud the world'/>
    <div className="flex flex-wrap justify-center gap-5 mt-8 text-left">
