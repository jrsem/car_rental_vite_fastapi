...
import { assets, dummyUserData, ownerMenuLinks } from '../../assets'
...
const Sidebar = () => {
  ...
  return (
    ...
    <div className='group relative'>
        <label htmlFor="image">
            <img 
             src={image instanceof File ? URL.createObjectURL(image) : user?.image || "https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=300"} 
